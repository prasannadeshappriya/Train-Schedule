    ...
    private class message extends AsyncTask<Void,Void,Void>{
        ...
        protected Void doInBackground(final Void... params) {
            try {
                StringRequest request = new StringRequest(Request.Method.POST, server_url,
                        ...
                        new Response.ErrorListener() {
                            ...
                            public void onErrorResponse(VolleyError error) {
                                ...
                                Log.i(Constants.TAG, "Error caught during request transmission :- " + error.toString());
                            }
                        }) {
                    @Override
                ...
                Log.i(Constants.TAG,"Time taken :- " + String.valueOf(duration));
            }catch (Exception e){
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            try {
                ...
                if (obj.has("error")) {
                    ...
                    Log.i(Constants.TAG, "Error :- " + obj.getString("error"));
                } else {
                    Toast.makeText(context,"Message Sent",Toast.LENGTH_LONG).show();
                    Log.i(Constants.TAG, "Message sending successfully");
                }
